...
onready var connected_texture = preload("res://Acessorios/art/default_with_connection.png")
onready var not_connected_texture = preload("res://Acessorios/art/default_no_connection.png")
