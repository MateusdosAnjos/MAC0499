...
var dialog = [
    ...
    'Arraste o comando "Print" para o espaço de ação e passe como argumento a palava "input" (sem aspas).\n\nIsso fará o input ser escrito em sua saída.\n\nO comando "Print" serve apenas para exibir o que é passado como argumento, ou seja, se o input for "Ovo" iremos mostrar o "Ovo" ao utilizar o comando "Print" com argumento input.',
