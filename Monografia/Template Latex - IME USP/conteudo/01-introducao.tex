...
\section{Objetivos dentro do Jogo}
\label{sec:consideracoes_preliminares}

Para que seja mais fácil entender o projeto como um todo, esta seção explicará
um pouco sobre os objetivos que o jogador deve alcançar ao jogar 
\textit{Phoenix Rising}. Na imagem abaixo está exemplificado um nível do jogo e
na sequência as explicações de cada elemento da tela.
...
O jogador irá receber dados que serão mostrados dentro do retângulo azul, no 
exemplo abaixo o jogador recebe como dado os números 7 e 41.
...
chamado "Resposta Esperada", no exemplo abaixo o jogador deve reproduzir os 
números 8 e 42. Após o programa do jogador ser executado a saída que ele obteve
aparecerá abaixo de "Sua Resposta" que está no retângulo vermelho e caso o 
resultado em "Sua Resposta" for igual ao que está em "Resposta Esperada" o
retângulo também ficará verde.
...
\section{Noção básica sobre como jogar}
\label{sec:consideracoes_preliminares}
