...
não dispõem do tempo necessário para o aprendizado tradicional, ou seja,
leituras extensas sobre os temas e longas sessões práticas para a aplicação das
técnicas aprendidas.\\
Neste momento os jogos ganham força como disseminadores do conhecimento, pois são
uma forma divertida e rápida de se adquirir experiência básica sobre algo.
Por ser uma forma simples e dinâmica de aprendizado o indíviduo tende a dispor
mais tempo para jogar um jogo do que ler um livro teórico sobre algo e é
por isso que Phoenix Rising tenta \textit{gamificar} uma plataforma de ensino,
com o intuito de auxiliar aqueles que querem aprender o básico da programação.
