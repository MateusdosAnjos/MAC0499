...
Vale ressaltar que o script \textit{ItemDB.gd} é um \textit{singleton} e é 
carregado antes mesmo que a cena atual se inicie, portanto todas as cenas do 
jogo podem acessar o conteúdo definido nele.

Sendo assim, a declaração do comando, feita em \textit{ItemDB.gd}, deve conter 
...
Abaixo está ilustrado uma parte das declarações dos comandos.
...
Para o melhor entendimento desta parte é importante saber um pouco sobre a 
estrutura de um dicionário. Basicamente um dicionário é uma forma de estruturar
os dados em que um elemento é chamado de chave e o outro elemento é chamado
de valor. Em um dicionário as chaves são únicas e os valores podem se repetir,
a partir disso o par chave e valor ficam atrelados e é possível obter
